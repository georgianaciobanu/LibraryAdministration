...
using SimbioMed.MultiTenancy.HostDashboard;
...
namespace SimbioMed.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SimbioMedDbContext context, SubscriptionPayment subscriptionPayment)
        {
