...
using SimbioMed.Core.Base;
using SimbioMed.Core.Extensions;
using SimbioMed.Dto;
using SimbioMed.Types;

namespace SimbioMed.Queries
{
    public class OrganizationUnitQuery : SimbioMedQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
