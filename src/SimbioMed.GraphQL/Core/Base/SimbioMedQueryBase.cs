...
namespace SimbioMed.Core.Base
{
    public abstract class SimbioMedQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected SimbioMedQueryBase(string fieldName,
