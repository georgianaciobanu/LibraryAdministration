...
namespace SimbioMed.Web.Public.Startup
{
    ...
    public class SimbioMedWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SimbioMedWebFrontEndModule(IWebHostEnvironment env, SimbioMedEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SimbioMedWebFrontEndModule).GetAssembly());
        }
    }
}
