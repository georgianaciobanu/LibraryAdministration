...
using SimbioMed.Url;
using SimbioMed.Web.Public.Startup;
using SimbioMed.Web.Session;

namespace SimbioMed.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SimbioMedViewComponent
    {
