...
{
    public class SubscriptionPaymentRepository : SimbioMedRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<SimbioMedDbContext> dbContextProvider)
