...
namespace SimbioMed.Migrations
{
    ...
    [Migration("20220506103518_added_PriceWithDiscount_for_saleDetail")]
    partial class added_PriceWithDiscount_for_saleDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimbioMed.Author.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SimbioMed.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SimbioMed.City.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SimbioMed.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SimbioMed.Publisher.Publisher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SimbioMed.Sale.DiscountSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("SimbioMed.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("SimbioMed.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SimbioMed.Book.BookCategory", b =>
                {
                    ...
                    b.HasOne("SimbioMed.Category.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("SimbioMed.Sale.DiscountSale", b =>
                {
                    ...
                    b.HasOne("SimbioMed.Sale.Sale", "Sale")
                        .WithMany("Discounts")
