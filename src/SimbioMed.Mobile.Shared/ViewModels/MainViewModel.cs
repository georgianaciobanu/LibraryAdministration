...
using SimbioMed.Commands;
using SimbioMed.Core.Threading;
using SimbioMed.Models.NavigationMenu;
using SimbioMed.Services.Navigation;
using SimbioMed.ViewModels.Base;
using Plugin.Media;
...
using SimbioMed.ApiClient;
using SimbioMed.Controls;
using SimbioMed.Dto;
using SimbioMed.Extensions;
using SimbioMed.Localization;
using SimbioMed.UI;
using SimbioMed.UI.Assets;
using SimbioMed.Views;
using DependencyResolver = SimbioMed.Core.Dependency.DependencyResolver;

namespace SimbioMed.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "SimbioMed";
