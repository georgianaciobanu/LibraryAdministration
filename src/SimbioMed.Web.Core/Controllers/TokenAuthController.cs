...
using SimbioMed.Authentication.TwoFactor.Google;
...
namespace SimbioMed.Web.Controllers
{
    ...
    public class TokenAuthController : SimbioMedControllerBase
    {
