...
using SimbioMed.Authentication.TwoFactor;
using SimbioMed.Chat;
using SimbioMed.Configuration;
using SimbioMed.EntityFrameworkCore;
using SimbioMed.Startup;
using SimbioMed.Web.Authentication.JwtBearer;
using SimbioMed.Web.Authentication.TwoFactor;
using SimbioMed.Web.Chat.SignalR;
using SimbioMed.Web.Common;
using SimbioMed.Web.Configuration;
using SimbioMed.Web.DashboardCustomization;

namespace SimbioMed.Web
{
    [DependsOn(
        typeof(SimbioMedApplicationModule),
        typeof(SimbioMedEntityFrameworkCoreModule),
    ...
    public class SimbioMedWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SimbioMedWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(SimbioMedApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SimbioMedWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(SimbioMedWebCoreModule).Assembly);
        }
