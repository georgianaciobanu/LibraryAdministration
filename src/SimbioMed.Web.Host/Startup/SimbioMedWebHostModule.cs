...
using SimbioMed.Web.Startup.ExternalLoginInfoProviders;

namespace SimbioMed.Web.Startup
{
    [DependsOn(
        typeof(SimbioMedWebCoreModule)
    )]
    public class SimbioMedWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SimbioMedWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SimbioMedWebHostModule).GetAssembly());
        }
