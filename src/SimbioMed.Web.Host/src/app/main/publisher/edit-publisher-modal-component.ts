...
import { PublisherServiceProxy, EditPublisherInput, CityServiceProxy, CityListDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'editPublisherModal',
    templateUrl: './edit-publisher-modal-component.html'
})
export class EditPublisherModalComponent extends AppComponentBase {
    ...
    selectedCity: number[] = [];
    publisher: EditPublisherInput = new EditPublisherInput();
    cities: CityListDto[] = [];
    ...
    show(authorId): void {
        ...
        this._publisherService.getPublisherForEdit(authorId).subscribe((result) => {
            this.publisher = result;
            this.selectedCity.push(this.publisher.cityId);
            this.modal.show();
        });
    }
    ...
    save(): void {
        ...
        this._publisherService.editPublisher(this.publisher)
            .pipe(finalize(() => this.saving = false))
            .subscribe(() => {
                this.notify.info(this.l('SavedSuccessfully'));
                this.close();
                this.spinnerService.hide();
                this.modalSave.emit(this.publisher);
