...
using SimbioMed.Auditing.Exporting;
using SimbioMed.Authorization;
using SimbioMed.Authorization.Users;
using SimbioMed.Dto;
using SimbioMed.EntityHistory;
using EntityHistoryHelper = SimbioMed.EntityHistory.EntityHistoryHelper;

namespace SimbioMed.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SimbioMedAppServiceBase, IAuditLogAppService
    {
