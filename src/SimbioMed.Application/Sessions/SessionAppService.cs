...
using SimbioMed.UiCustomization;
...
{
    public class SessionAppService : SimbioMedAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = SimbioMedConsts.Currency,
                        CurrencySign = SimbioMedConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = SimbioMedConsts.AllowTenantsToChangeEmailSettings,
