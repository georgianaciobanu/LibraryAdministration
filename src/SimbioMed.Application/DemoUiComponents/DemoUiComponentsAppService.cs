...
using SimbioMed.DemoUiComponents.Dto;

namespace SimbioMed.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SimbioMedAppServiceBase, IDemoUiComponentsAppService
    {
