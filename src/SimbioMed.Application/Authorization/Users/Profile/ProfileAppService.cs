...
using SimbioMed.Authorization.Users.Profile.Cache;
using SimbioMed.Authorization.Users.Profile.Dto;
using SimbioMed.Configuration;
using SimbioMed.Friendships;
using SimbioMed.Gdpr;
using SimbioMed.Net.Sms;
using SimbioMed.Security;
using SimbioMed.Storage;
using SimbioMed.Timing;

namespace SimbioMed.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : SimbioMedAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("SimbioMed",
