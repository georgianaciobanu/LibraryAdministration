...
using SimbioMed.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace SimbioMed.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SimbioMedAppServiceBase, IDashboardCustomizationAppService
    {
