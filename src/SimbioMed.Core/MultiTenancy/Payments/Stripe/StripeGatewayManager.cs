...
{
    public class StripeGatewayManager : SimbioMedServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "SimbioMed";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + SimbioMedConsts.Currency;
        }
