...
using SimbioMed.Authorization.Ldap;
using SimbioMed.Authorization.Roles;
using SimbioMed.Authorization.Users;
using SimbioMed.Chat;
using SimbioMed.Configuration;
using SimbioMed.DashboardCustomization.Definitions;
using SimbioMed.Debugging;
using SimbioMed.DynamicEntityProperties;
using SimbioMed.Features;
using SimbioMed.Friendships;
using SimbioMed.Friendships.Cache;
using SimbioMed.Localization;
using SimbioMed.MultiTenancy;
using SimbioMed.Net.Emailing;
using SimbioMed.Notifications;
using SimbioMed.WebHooks;
using Newtonsoft.Json;

namespace SimbioMed
{
    [DependsOn(
        typeof(SimbioMedCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class SimbioMedCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            SimbioMedLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = SimbioMedConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SimbioMedMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SimbioMedSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SimbioMedCoreModule).GetAssembly());
        }
